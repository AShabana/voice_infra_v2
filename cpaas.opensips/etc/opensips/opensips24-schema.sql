...
--
-- Host: 192.168.13.100    Database: opensips24
-- ------------------------------------------------------
...
INSERT INTO `version` VALUES ('acc',7),('address',5),('aliases',1009),('b2b_entities',1),('b2b_logic',3),('cachedb',2),('carrierfailureroute',2),('carrierroute',3),('cc_agents',1),('cc_cdrs',1),('cc_flows',1),('cpl',2),('dbaliases',2),('dialog',10),('dialplan',5),('dispatcher',8),('domain',3),('domainpolicy',3),('dr_carriers',2),('dr_gateways',6),('dr_groups',2),('dr_partitions',1),('dr_rules',3),('emergency_report',1),('emergency_routing',1),('emergency_service_provider',1),('fraud_detection',1),('freeswitch',1),('globalblacklist',2),('grp',3),('imc_members',2),('imc_rooms',2),('load_balancer',2),('location',1013),('missed_calls',5),('registrant',1),('re_grp',2),('route_tree',2),('silo',6),('sip_trace',5),('speed_dial',3),('subscriber',7),('uri',2),('userblacklist',2),('usr_preferences',3);
...
-- Dump completed on 2019-03-11 20:11:25
